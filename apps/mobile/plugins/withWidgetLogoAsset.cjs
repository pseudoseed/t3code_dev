...
// Ships the PseudoCode icon to the Live Activity / widget extension.
//
// expo-widgets generates ExpoWidgetsTarget without a Resources build phase and
// has no asset support, so this plugin (a) writes the app icon image set into
...
const IMAGE_SET = "AppMark.imageset";
const IMAGE_NAME = "AppMark.png";
  ...
  return withDangerousMod(config, [
    ...
    (cfg) => {
      const source = path.resolve(
        ...
        "../../assets/pseudocode/app-icon-180.png",
      );
