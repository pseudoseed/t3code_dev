...
interface CloudEnvironmentRowsProps {
  ...
  /**
   * Hide the "Cloud Connect" section title + refresh button for hosts that
...
/**
 * "Cloud Connect" section: every environment published to the signed-in account,
 * with connect switches, availability status, refresh, and loading/error
 * states. Shared between the Settings environments screen and the Cloud Connect
 * onboarding sheet.
 *
