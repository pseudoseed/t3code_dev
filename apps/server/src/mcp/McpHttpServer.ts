...
import { IssueToolkitHandlersLive } from "./toolkits/issues/handlers.ts";
import { IssueToolkit } from "./toolkits/issues/tools.ts";
...
const IssueToolkitRegistrationLive = McpServer.toolkit(IssueToolkit).pipe(
