          ...
          ([
            ...
            Effect.gen(function* () {
              ...
              const threads: ReadonlyArray<OrchestrationThread> = threadRows.map((row) => ({
                ...
                subagentModelSelection: row.subagentModelSelection,
                runtimeMode: row.runtimeMode,
  ...
  const getThreadShellById: ProjectionSnapshotQueryShape["getThreadShellById"] = (threadId) =>
    Effect.gen(function* () {
      ...
      return Option.some({
        ...
        subagentModelSelection: threadRow.value.subagentModelSelection,
        ...
        lastViewedAt: threadRow.value.lastViewedAt ?? null,
