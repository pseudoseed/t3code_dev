...
export const T3_CHAT_THEME_LABEL = "PseudoCode";
...
/**
 * The palette PseudoCode wears with no theme installed, captured from the app's
...
/**
 * The standard PseudoCode look as a theme palette, for seeding a new theme when
...
/**
 * The status colors PseudoCode shows without a theme, read from the app's own
