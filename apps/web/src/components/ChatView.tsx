...
function ChatViewContent(props: ChatViewProps) {
  ...
  // Issues follow the project rather than the thread, so the panel needs one to read from.
  ...
  const rightPanelContent = activeThreadRef ? (
    renderedRightPanelSurface?.kind === "preview" ? (
      ...
      <PullRequestsUnavailableState
        ...
        error="Update this environment's PseudoCode server to browse pull requests."
      />
      ...
      />
    ) : renderedRightPanelSurface?.kind === "issues" && activeProject && activeWorkspaceRoot ? (
      <Suspense fallback={null}>
        <IssuesPanel
          ...
          openNumber={renderedRightPanelSurface.openNumber}
          openRequestId={renderedRightPanelSurface.openRequestId}
          composerDraftTarget={composerDraftTarget}
        />
      </Suspense>
    ...
    <div className="relative flex min-h-0 min-w-0 flex-1 overflow-hidden bg-background">
      ...
      {rightPanelPresent && !shouldUseRightPanelSheet && activeThreadRef ? (
        <RightPanelTabs
          ...
          agentsAvailable
          issuesAvailable={activeProject !== null && activeProject !== undefined}
