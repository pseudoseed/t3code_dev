...
> = {
  ...
  create_threads: ["Create", "Creating", "Created", "PseudoCode threads"],
  t3_thread_start: ["Start", "Starting", "Started", "a PseudoCode thread"],
  t3_thread_list: ["List", "Listing", "Listed", "PseudoCode threads"],
  t3_thread_read: ["Read", "Reading", "Read", "a PseudoCode thread"],
  t3_thread_send: ["Send", "Sending", "Sent", "to a PseudoCode thread"],
  t3_thread_wait: ["Wait", "Waiting", "Waited", "for a PseudoCode thread"],
  t3_thread_interrupt: ["Interrupt", "Interrupting", "Interrupted", "a PseudoCode thread"],
