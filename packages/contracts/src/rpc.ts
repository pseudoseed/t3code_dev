...
const WsUsageLimitSourceConsumeResetCreditRpc = Rpc.make(
...
const WsMailboxGetRpc = Rpc.make(WS_METHODS.mailboxGet, {
  payload: MailboxGetInput,
  success: MailboxGetResult,
  error: Schema.Union([MailboxError, EnvironmentAuthorizationError]),
});
const WsMailboxUpdateRpc = Rpc.make(WS_METHODS.mailboxUpdate, {
...
const WsIssuesSetStateRpc = Rpc.make(WS_METHODS.issuesSetState, {
