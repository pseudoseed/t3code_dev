...
describe("brand-assets", () => {
  ...
  it("uses PseudoCode app icons for every build channel", () => {
    expect([
    ...
    expect(BRAND_ASSET_PATHS.developmentDesktopIconPng).toMatch(/^assets\/pseudocode\//);
    expect(BRAND_ASSET_PATHS.nightlyMacIconPng).toMatch(/^assets\/pseudocode\//);
    expect(BRAND_ASSET_PATHS.productionMacIconPng).toMatch(/^assets\/pseudocode\//);
  });
});
