...
Both instances must use the same **CODEX_HOME path**. PseudoCode prepares the shared
...
Choose the other account from the thread's model picker. PseudoCode offers compatible
