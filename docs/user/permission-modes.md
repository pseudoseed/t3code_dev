...
Antigravity uses its own permission policy for each mode. PseudoCode still shows any approval or
...
PseudoCode's separate Plan mode control is not available for Antigravity. See
